...
LOCAL_CXXFLAGS += -O2 -std=gnu++11 -DNDEBUG -DUSE_SPEEDHACKS -D__LIBRETRO_OPTIMIZATIONS__ -D__LIBRETRO__ -Wno-write-strings -DANDROID -DFRONTEND_SUPPORTS_RGB565 $(GLOBAL_DEFINES) -DGIT_VERSION=\"$(GIT_VERSION)\
LOCAL_CFLAGS = -O2 -std=gnu99 -DNDEBUG -DUSE_SPEEDHACKS -D__LIBRETRO_OPTIMIZATIONS__ -D__LIBRETRO__ -Wno-write-strings -DANDROID -DFRONTEND_SUPPORTS_RGB565 $(GLOBAL_DEFINES) -DGIT_VERSION=\"$(GIT_VERSION)\
