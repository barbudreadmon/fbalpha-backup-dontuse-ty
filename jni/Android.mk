...
ifneq ($(GIT_VERSION)," unknown")
	PRIVATE_CPPFLAGS += -DGIT_VERSION=\"$(GIT_VERSION)\"
	LOCAL_CFLAGS += -DGIT_VERSION=\"$(GIT_VERSION)\"
endif

ifeq ($(TARGET_ARCH),arm)
	PRIVATE_CPPFLAGS += -DANDROID_ARM -DARM -marm
...
ifeq ($(TARGET_ARCH),x86)
	PRIVATE_CPPFLAGS +=  -DANDROID_X86
endif

ifeq ($(TARGET_ARCH),mips)
	PRIVATE_CPPFLAGS += -DANDROID_MIPS -D__mips__ -D__MIPSEL__
endif
...
LOCAL_SRC_FILES += $(LIBRETRO_DIR)/libretro.cpp $(LIBRETRO_DIR)/neocdlist.cpp $(LIBRETRO_DIR)/gami.cpp $(LIBRETRO_DIR)/gamc.cpp
...
ifeq ($(USE_OLD_MAPPING), 1)
   ...
   LOCAL_SRC_FILES += $(LIBRETRO_DIR)/bind_map.cpp
endif
...
PRIVATE_CPPFLAGS += -O3 -DNDEBUG -DUSE_SPEEDHACKS -D__LIBRETRO_OPTIMIZATIONS__ -D__LIBRETRO__ -Wno-write-strings -Wno-c++11-narrowing -DANDROID -DFRONTEND_SUPPORTS_RGB565 $(GLOBAL_DEFINES)
LOCAL_CFLAGS = -O3 -std=gnu99 -DNDEBUG -DUSE_SPEEDHACKS -D__LIBRETRO_OPTIMIZATIONS__ -D__LIBRETRO__ -Wno-write-strings -DANDROID -DFRONTEND_SUPPORTS_RGB565 $(GLOBAL_DEFINES)
