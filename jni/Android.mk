...
ifneq ($(GIT_VERSION)," unknown")
	LOCAL_CPPFLAGS += -DGIT_VERSION=\"$(GIT_VERSION)\"
	LOCAL_CFLAGS += -DGIT_VERSION=\"$(GIT_VERSION)\"
endif

ifeq ($(TARGET_ARCH),arm)
	LOCAL_CPPFLAGS += -DANDROID_ARM -DARM -marm
...
LOCAL_CPPFLAGS += -O3 -DNDEBUG -DUSE_SPEEDHACKS -D__LIBRETRO_OPTIMIZATIONS__ -D__LIBRETRO__ -Wno-write-strings -Wno-c++11-narrowing -DANDROID -DFRONTEND_SUPPORTS_RGB565 $(GLOBAL_DEFINES)
