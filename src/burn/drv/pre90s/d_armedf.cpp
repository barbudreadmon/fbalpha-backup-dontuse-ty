...
static struct BurnInputInfo Cclimbr2InputList[] = {
	...
	{"P1 Up 2",		BIT_DIGITAL,	DrvJoy1 + 4,	"p1 up 2"		},
	{"P1 Down 2",		BIT_DIGITAL,	DrvJoy1 + 5,	"p1 down 2"	},
	{"P1 Left 2",		BIT_DIGITAL,	DrvJoy1 + 6,	"p1 left 2"	},
	{"P1 Right 2",		BIT_DIGITAL,	DrvJoy1 + 7,	"p1 right 2"	},
	...
	{"P2 Up 2",		BIT_DIGITAL,	DrvJoy2 + 4,	"p2 up 2"		},
	{"P2 Down 2",		BIT_DIGITAL,	DrvJoy2 + 5,	"p2 down 2"	},
	{"P2 Left 2",		BIT_DIGITAL,	DrvJoy2 + 6,	"p2 left 2"	},
	{"P2 Right 2",		BIT_DIGITAL,	DrvJoy2 + 7,	"p2 right 2"	},
...
static UINT32 m_scroll_msb = 0;
static UINT16 m_vreg = 0;
...
static INT32 DrvDraw()
{
	...
	if (scroll_type == 0) { // terraf
		DrvScroll[2] = m_fg_scrollx;
		DrvScroll[3] = m_fg_scrolly;
	}
...
struct BurnDriver BurnDrvTerraf = {
	...
	TerrafInit, DrvExit, DrvFrameTerraf, DrvDraw, DrvScan, &DrvRecalc, 0x800,
	320, 240, 4, 3
};
