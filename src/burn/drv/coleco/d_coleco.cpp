...
static struct BurnInputInfo ColecoInputList[] = {
	...
	{"P1 P1#0",		BIT_DIGITAL,	DrvJoy1 +  0,	"p1 numpad 0"		},
	{"P1 P1#1",		BIT_DIGITAL,	DrvJoy1 +  1,	"p1 numpad 1"		},
	{"P1 P1#2",		BIT_DIGITAL,	DrvJoy1 +  2,	"p1 numpad 2"		},
	{"P1 P1#3",		BIT_DIGITAL,	DrvJoy1 +  3,	"p1 numpad 3"		},
	{"P1 P1#4",		BIT_DIGITAL,	DrvJoy1 +  4,	"p1 numpad 4"		},
	{"P1 P1#5",		BIT_DIGITAL,	DrvJoy1 +  5,	"p1 numpad 5"		},
	{"P1 P1#6",		BIT_DIGITAL,	DrvJoy1 +  6,	"p1 numpad 6"		},
	{"P1 P1#7",		BIT_DIGITAL,	DrvJoy1 +  7,	"p1 numpad 7"		},
	{"P1 P1#8",		BIT_DIGITAL,	DrvJoy1 +  8,	"p1 numpad 8"		},
	{"P1 P1#9",		BIT_DIGITAL,	DrvJoy1 +  9,	"p1 numpad 9"		},
	{"P1 #",		BIT_DIGITAL,	DrvJoy1 + 10,	"p1 numpad #"		},
	{"P1 *",		BIT_DIGITAL,	DrvJoy1 + 11,	"p1 numpad *"		},

	{"P3 Up",		BIT_DIGITAL,	DrvJoy4 + 0,	"p2 up"		},
	{"P3 Down",		BIT_DIGITAL,	DrvJoy4 + 2,	"p2 down"	},
	{"P3 Left",		BIT_DIGITAL,	DrvJoy4 + 3,	"p2 left"	},
	{"P3 Right",	BIT_DIGITAL,	DrvJoy4 + 1,	"p2 right"	},
	{"P3 Fire 1",	BIT_DIGITAL,	DrvJoy4 + 6,	"p2 fire 1"	},
	{"P3 Fire 2",	BIT_DIGITAL,	DrvJoy3 + 14,	"p2 fire 2"	},
	{"P3 P3#0",		BIT_DIGITAL,	DrvJoy3 +  0,	"p2 numpad 0"		},
	{"P3 P3#1",		BIT_DIGITAL,	DrvJoy3 +  1,	"p2 numpad 1"		},
	{"P3 P3#2",		BIT_DIGITAL,	DrvJoy3 +  2,	"p2 numpad 2"		},
	{"P3 P3#3",		BIT_DIGITAL,	DrvJoy3 +  3,	"p2 numpad 3"		},
	{"P3 P3#4",		BIT_DIGITAL,	DrvJoy3 +  4,	"p2 numpad 4"		},
	{"P3 P3#5",		BIT_DIGITAL,	DrvJoy3 +  5,	"p2 numpad 5"		},
	{"P3 P3#6",		BIT_DIGITAL,	DrvJoy3 +  6,	"p2 numpad 6"		},
	{"P3 P3#7",		BIT_DIGITAL,	DrvJoy3 +  7,	"p2 numpad 7"		},
	{"P3 P3#8",		BIT_DIGITAL,	DrvJoy3 +  8,	"p2 numpad 8"		},
	{"P3 P3#9",		BIT_DIGITAL,	DrvJoy3 +  9,	"p2 numpad 9"		},
	{"P3 #",		BIT_DIGITAL,	DrvJoy3 + 10,	"p2 numpad #"		},
	{"P3 *",		BIT_DIGITAL,	DrvJoy3 + 11,	"p2 numpad *"		},
