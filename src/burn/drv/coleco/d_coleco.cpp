...
static struct BurnInputInfo ColecoInputList[] = {
	{"P1 P1 Up",		BIT_DIGITAL,	DrvJoy2 + 0,	"p1 up"		},
	{"P1 P1 Down",		BIT_DIGITAL,	DrvJoy2 + 2,	"p1 down"	},
	{"P1 P1 Left",		BIT_DIGITAL,	DrvJoy2 + 3,	"p1 left"	},
	{"P1 P1 Right",	BIT_DIGITAL,	DrvJoy2 + 1,	"p1 right"	},
	{"P1 P1 Fire 1",	BIT_DIGITAL,	DrvJoy2 + 6,	"p1 fire 1"	},
	{"P1 P1 Fire 2",	BIT_DIGITAL,	DrvJoy1 + 14,	"p1 fire 2"	},
	{"P2 P1 0",		BIT_DIGITAL,	DrvJoy1 +  0,	"p2 fire 8"		},
	{"P2 P1 1",		BIT_DIGITAL,	DrvJoy1 +  1,	"p2 start"		},
	{"P2 P1 2",		BIT_DIGITAL,	DrvJoy1 +  2,	"p2 select"		},
	{"P2 P1 3",		BIT_DIGITAL,	DrvJoy1 +  3,	"p2 fire 1"		},
	{"P2 P1 4",		BIT_DIGITAL,	DrvJoy1 +  4,	"p2 fire 2"		},
	{"P2 P1 5",		BIT_DIGITAL,	DrvJoy1 +  5,	"p2 fire 3"		},
	{"P2 P1 6",		BIT_DIGITAL,	DrvJoy1 +  6,	"p2 fire 4"		},
	{"P2 P1 7",		BIT_DIGITAL,	DrvJoy1 +  7,	"p2 fire 5"		},
	{"P2 P1 8",		BIT_DIGITAL,	DrvJoy1 +  8,	"p2 fire 6"		},
	{"P2 P1 9",		BIT_DIGITAL,	DrvJoy1 +  9,	"p2 fire 7"		},
	{"P1 P1 #",		BIT_DIGITAL,	DrvJoy1 + 10,	"p1 select"		},
	{"P1 P1 *",		BIT_DIGITAL,	DrvJoy1 + 11,	"p1 start"		},

	{"P4 P2 Up",		BIT_DIGITAL,	DrvJoy4 + 0,	"p3 up"		},
	{"P4 P2 Down",		BIT_DIGITAL,	DrvJoy4 + 2,	"p3 down"	},
	{"P4 P2 Left",		BIT_DIGITAL,	DrvJoy4 + 3,	"p3 left"	},
	{"P4 P2 Right",	BIT_DIGITAL,	DrvJoy4 + 1,	"p3 right"	},
	{"P4 P2 Fire 1",	BIT_DIGITAL,	DrvJoy4 + 6,	"p3 fire 1"	},
	{"P4 P2 Fire 2",	BIT_DIGITAL,	DrvJoy3 + 14,	"p3 fire 2"	},
	{"P4 P2 0",		BIT_DIGITAL,	DrvJoy3 +  0,	"p4 fire 8"		},
	{"P4 P2 1",		BIT_DIGITAL,	DrvJoy3 +  1,	"p4 start"		},
	{"P4 P2 2",		BIT_DIGITAL,	DrvJoy3 +  2,	"p4 select"		},
	{"P4 P2 3",		BIT_DIGITAL,	DrvJoy3 +  3,	"p4 fire 1"		},
	{"P4 P2 4",		BIT_DIGITAL,	DrvJoy3 +  4,	"p4 fire 2"		},
	{"P4 P2 5",		BIT_DIGITAL,	DrvJoy3 +  5,	"p4 fire 3"		},
	{"P4 P2 6",		BIT_DIGITAL,	DrvJoy3 +  6,	"p4 fire 4"		},
	{"P4 P2 7",		BIT_DIGITAL,	DrvJoy3 +  7,	"p4 fire 5"		},
	{"P4 P2 8",		BIT_DIGITAL,	DrvJoy3 +  8,	"p4 fire 6"		},
	{"P4 P2 9",		BIT_DIGITAL,	DrvJoy3 +  9,	"p4 fire 7"		},
	{"P3 P2 #",		BIT_DIGITAL,	DrvJoy3 + 10,	"p3 select"		},
	{"P3 P2 *",		BIT_DIGITAL,	DrvJoy3 + 11,	"p3 start"		},
